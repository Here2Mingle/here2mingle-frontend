<template>
    <div>
        <featuremenu />
        <section data-bs-version="5.1" class="mbr-section features13 cid-twluN2bIob mbr-parallax-background"
            id="features13-7">
                ...
                <div class="row">
                    <div class="col-12 text-row col-md-6">
                        ...
                        <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">
                            Videos from around the world by the community</h3>
